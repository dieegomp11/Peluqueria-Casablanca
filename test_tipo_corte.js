...
const url = 'https://dcsuklyaqivlptrdazkd.supabase.co/rest/v1/Tipo Corte?limit=1';
fetch(url, {headers}).then(r=>r.json()).then(d=>fs.writeFileSync('tipo_corte.json', JSON.stringify(d, null, 2))).catch(console.error);
